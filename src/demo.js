...
import backIcon from "./components/images/Back Arrow.png";
...
const SQLEditor = () => {
  ...
  const handleSkipConfirmation = () => {
    ...
    handleSkip();
    navigate('/SQLEditor', { state: { questionData: completeData } });
    ...
    <div className="d-flex flex-column vh-100">
      ...
      <div className="container-fluid flex-grow-1 py-3 overflow-hidden">
        <div className="row h-100 g-0">
                      ...
                      <div>
                        {tableData.map((table, index) => (
                          table.tab_name === activeTab && (
                            <table key={index} className="table table-bordered table-sm rounded" style={{ maxWidth: "100vw", width: "50vw", fontSize: "12px" }}>
                              <thead>
                                <tr>
          ...
          <div className="d-flex flex-column RightDiv" style={{ flex: "1", height: "100%", marginLeft: "20px" }}>
            ...
            <div className="border border-dark rounded-2 me-3 " style={{ height: "45%", backgroundColor: "#E5E5E533" }}>
              ...
              <div className="p-3 varun" style={{ height: "calc(80% - 80px)", overflowY: "auto", overflowX: "auto", maxWidth: "100%" }}>
  {runResponseTable.length > 0 && (
    <table className="table table-bordered table-sm rounded" style={{ width: "100%", tableLayout: "auto", fontSize: "12px" }}>
      <thead>
        <tr>
  ...
  <div className="mt-3">
    {runResponseTestCases.map((testCase, index) => (
      ...
      >
        ...
        <span style={{ color: Object.values(testCase)[0] === "Passed" || Object.values(testCase)[0] === "True" ? "blue" : "red" }}>
